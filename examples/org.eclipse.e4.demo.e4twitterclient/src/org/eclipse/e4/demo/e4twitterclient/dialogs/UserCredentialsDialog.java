...
public class UserCredentialsDialog extends Dialog {
	...
	public static Credentials askForCredentials(String host, String message, String userName) {
		UserCredentialsDialog ui = new UserCredentialsDialog(null, host, message, userName);
		ui.open();

		return ui.getCredentials();
	}

	private UserCredentialsDialog(Shell parentShell, String host, String message, String userName) {
		super(parentShell);
		this.host = host;
